...
export default function ProjectIcon({ isHovered, className = "", iconColor }: ProjectIconProps) {
  ...
  return (
    <div ref={containerRef} className={`relative ${iconColor ? 'w-24 h-24' : 'w-48 h-48'} ${className}`} style={{ color: iconColor }}>
      {/* Monitor SVG - Static */}
      <svg
        viewBox="0 0 100 100"
      ...
      >
        ...
        <rect
          ...
          style={{ 
            fill: iconColor ? iconColor : 'var(--monitor-frame-color, white)',
        ...
        <rect
          ...
          ry="2"
          className="transition-colors duration-300"
          style={{ fill: iconColor ? 'var(--page-background)' : 'var(--color-projects)' }}
        />
        ...
        <rect
          ...
          height="8"
          className="transition-colors duration-300"
          style={{ fill: iconColor ? iconColor : 'currentColor' }}
        />
