...
interface SoftwareDevOverlayProps {
...
export default function SoftwareDevOverlay({ 
  overlayRef, 
  bgColor, 
  onClose, 
  children
}: SoftwareDevOverlayProps) {
  return (
    <div 
      ref={overlayRef} 
    ...
    >
      ...
      <div className="overlay-content h-full flex flex-col">
        <div className="flex items-center justify-between mb-8 lg:mb-16">
          <h2 className="text-4xl lg:text-6xl font-bold text-white">Software Dev</h2>
        </div>
